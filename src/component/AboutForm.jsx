...
function AboutForm() {
  ...
  const aboutFormSubmit = async (e) => {
    ...
    if (!key) {
      ...
      const resData = await fetch("/abouts", {
        method: "POST",
        headers: {
      ...
      if (userData.status.code !== 200) {
        console.log("Already have an account in this Id");
        window.alert("Already have an account in this Id");
      } else {
      ...
      <section className="min-h-screen flex items-stretch text-white ">
        ...
        >
          ...
          <div className="w-full py-6 z-20">
            <h1 className="my-6 text-5xl">About Form</h1>
            ...
            <form action className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
              ...
              <div className="flex items-center space-x-6">
                ...
                <label class="block">
                  <span class="sr-only">Add profile pic</span>
                  <input
                    type="file"
